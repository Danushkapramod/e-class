...
function LeftSection({ auther }) {
  ...
  return (
    <div className=" border-border-1 flex min-w-96 grow flex-col items-center rounded-md  border p-6 shadow-md">
      <div className="border-border-1 mt-4 rounded-full border-2 p-1.5 shadow-md">
...
function RightSection() {
  ...
  return (
    <div className=" border-border-1 h-[23rem] grow rounded-md border bg-bg--primary-300 p-6 shadow-md">
      <div className="">
